    ...
    >
      <Title ta="center" order={1}>
        ...
        <Text
          fw={800}
          variant="gradient"
          gradient={{ from: "rgba(231,84,135,255)", to: "black", deg: 90 }}
          inherit
        >
          ✨ Lama ✨
        </Text>
      ...
      <Container p={0} size={600}>
        <Text size="lg" c="dimmed" line-height={1.5} ta="center" mt="md">
          ...
          <Text component="span" size="lg" c="black" fw={700}>
            {" "}
            Pubg mobile
          </Text>
          , three years ago, multiple times people missed spelling my name. Most
          of them thought it was Llama. Actually, Turkish people used to call me
          "Hayvan" which means animal in English
          <Text component="span" size="lg" c="black" fw={700}>
            {" "}
            lol
          </Text>
