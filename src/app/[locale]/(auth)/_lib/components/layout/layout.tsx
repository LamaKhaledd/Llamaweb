    ...
    <Container>
      ...
      >
        <AppShell.Header>
          ...
          <Container w={"100%"} ><Summary /></Container>
          <Container w={"100%"} ><About /></Container>
          <Container w={"100%"} ><Inisghts /></Container>
          <Container w={"100%"} ><Qoutes /></Container>
          <Container w={"100%"} ><Contact /></Container>
          </Flex>
      </AppShell>
    </Container>
  );
